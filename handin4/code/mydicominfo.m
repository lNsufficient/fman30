...
%VR:
%http://northstar-www.dartmouth.edu/doc/idl/html_6.2/Value_Representations.html#wp1023525,
%dessa jämfördes med de ovan implementerade, där deras VR var:
%TransferSyntaxUID - UI
%StartOfPixelData - OW or OB
%BitsAllocated - US
%RescaleSlope - DS
%De som var US jämfördes med typen på BitsAllocated, de som var DS
%jämfördes med RescaleSlope. 
%OBS! Jag �ndrade i RescaleSlope fr�n 1, till '1' p� default value, annars
%funkade inte str2double. 

%VR: US
i = 5;
t(i).name = 'Rows';         t(i).groupnumber = '0028'; t(i).elementnumber = '0010'; t(i).type = 'uint16';   t(i).default=[];
i = i+1;

%VR: US
t(i).name = 'Columns';         t(i).groupnumber = '0028'; t(i).elementnumber = '0011'; t(i).type = 'uint16';   t(i).default=[];
i = i+1;

%VR: DS
t(i).name = 'PixelSpacing';         t(i).groupnumber = '0028'; t(i).elementnumber = '0030'; t(i).type = 'char';   t(i).default=[];
i = i+1;
       
%VR: US
t(i).name = 'BitsStored';         t(i).groupnumber = '0028'; t(i).elementnumber = '0101'; t(i).type = 'uint16';   t(i).default=[];
i = i+1;
...
%VR: DS
t(i).name = 'SliceThickness';         t(i).groupnumber = '0018'; t(i).elementnumber = '0050'; t(i).type = 'char';   t(i).default=[];
i = i+1;
